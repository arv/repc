...
impl<'a> LeafEntry<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args LeafEntryArgs<'args>) -> flatbuffers::WIPOffset<LeafEntry<'bldr>> {
  ...
  pub fn key(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(LeafEntry::VT_KEY, None).map(|v| v.safe_slice())
  }
  #[inline]
  pub fn val(&self) -> Option<&'a [u8]> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(LeafEntry::VT_VAL, None).map(|v| v.safe_slice())
  }
}
...
impl<'a: 'b, 'b> LeafEntryBuilder<'a, 'b> {
  ...
  pub fn add_key(&mut self, key: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LeafEntry::VT_KEY, key);
  }
  #[inline]
  pub fn add_val(&mut self, val: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LeafEntry::VT_VAL, val);
  }
  #[inline]
...
impl<'a> Leaf<'a> {
  ...
  #[inline]
  pub fn entries(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<LeafEntry<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<LeafEntry<'a>>>>>(Leaf::VT_ENTRIES, None)
  }
}

pub struct LeafArgs<'a> {
    pub entries: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a , flatbuffers::ForwardsUOffset<LeafEntry<'a >>>>>,
}
...
impl<'a: 'b, 'b> LeafBuilder<'a, 'b> {
  #[inline]
  pub fn add_entries(&mut self, entries: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<LeafEntry<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Leaf::VT_ENTRIES, entries);
  }
  #[inline]
...
#[inline]
pub fn finish_size_prefixed_leaf_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<Leaf<'a>>) {
